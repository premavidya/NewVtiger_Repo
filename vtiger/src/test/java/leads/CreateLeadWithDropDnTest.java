...
public class CreateLeadWithDropDnTest {

	@Test
	public void createLeadWithDropDown() throws IOException, InterruptedException
	{
		...
		wutil.selectByValue(driver.findElement(By.name("leadsource")), excel.getDataFromExcel("Lead", 1, 2));
		wutil.selectByValue(driver.findElement(By.name("industry")), excel.getDataFromExcel("Lead", 1, 3));
		wutil.selectByValue(driver.findElement(By.name("leadstatus")), excel.getDataFromExcel("Lead", 1, 4));
		wutil.selectByValue(driver.findElement(By.name("rating")), excel.getDataFromExcel("Lead", 1, 5));
